...
public abstract class AbstractDynamicRouteService implements DynamicRouteService {
    ...
    private final static Logger log = LoggerFactory.getLogger(AbstractDynamicRouteService.class);
    ...
    public AbstractDynamicRouteService(RouteDefinitionWriter routeDefinitionWriter, RouteDefinitionLocator routeDefinitionLocator, ApplicationEventPublisher publisher) {
